...
3. **Tag and Push to ECR**
   ```bash
   # Login to ECR
   aws ecr get-login-password --region us-east-1 | docker login --username AWS --password-stdin 910673207244.dkr.ecr.us-east-1.amazonaws.com
   
   # Tag images
   docker tag agentcore-purchase-agent:latest 910673207244.dkr.ecr.us-east-1.amazonaws.com/agentcore-purchase-agent:latest
   docker tag agentcore-cement-agent:latest 910673207244.dkr.ecr.us-east-1.amazonaws.com/agentcore-cement-agent:latest
   docker tag agentcore-steel-agent:latest 910673207244.dkr.ecr.us-east-1.amazonaws.com/agentcore-steel-agent:latest
   
   # Push images
   docker push 910673207244.dkr.ecr.us-east-1.amazonaws.com/agentcore-purchase-agent:latest
   docker push 910673207244.dkr.ecr.us-east-1.amazonaws.com/agentcore-cement-agent:latest
   docker push 910673207244.dkr.ecr.us-east-1.amazonaws.com/agentcore-steel-agent:latest
   ```
...
1. **Deploy Each Agent**
   ...
   aws bedrock-agent-runtime create-agent \
     ...
     --agent-resource-role-arn arn:aws:iam::910673207244:role/AgentCoreExecutionRole
   ```
