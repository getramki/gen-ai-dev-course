...
class EnhancedPurchaseAgent(PurchaseAgent):
    ...
    async def _call_mcp_tool(self, tool_name: str, **kwargs) -> Dict:
        ...
        try:
            from mcp_client import call_construction_tool
            return await call_construction_tool(tool_name, **kwargs)
        except Exception as e:
            print(f"⚠️ Construction MCP tool call failed: {e}")
            return {"error": str(e)}
    
    async def _analyze_requirements_with_tools(self, state: EnhancedPurchaseState) -> EnhancedPurchaseState:
        ...
        try:
            result = await self._call_mcp_tool("create_project", **project_data)
    ...
    async def _calculate_total_cost_mcp(self, state: EnhancedPurchaseState) -> EnhancedPurchaseState:
    ...
    async def _track_budget_mcp(self, state: EnhancedPurchaseState) -> EnhancedPurchaseState:
    ...
    async def _analyze_suppliers_mcp(self, state: EnhancedPurchaseState) -> EnhancedPurchaseState:
    ...
    async def _calculate_roi_mcp(self, state: EnhancedPurchaseState) -> EnhancedPurchaseState:
