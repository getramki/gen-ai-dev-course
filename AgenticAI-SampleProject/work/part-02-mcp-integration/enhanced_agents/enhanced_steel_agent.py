...
class EnhancedSteelAgent(SteelAgent):
    ...
    async def _call_mcp_tool(self, tool_name: str, **kwargs) -> Dict:
        ...
        try:
            from mcp_client import call_steel_tool
            return await call_steel_tool(tool_name, **kwargs)
        except Exception as e:
            print(f"⚠️ Steel MCP tool call failed: {e}")
            return {"error": str(e)}
    
    async def _calculate_inventory_costs_mcp(self, state: EnhancedSteelState) -> EnhancedSteelState:
    ...
    async def _optimize_grade_pricing_mcp(self, state: EnhancedSteelState) -> EnhancedSteelState:
    ...
    async def _analyze_market_position_mcp(self, state: EnhancedSteelState) -> EnhancedSteelState:
    ...
    async def _calculate_delivery_impact_mcp(self, state: EnhancedSteelState) -> EnhancedSteelState:
    ...
    async def _evaluate_bulk_strategy_mcp(self, state: EnhancedSteelState) -> EnhancedSteelState:
    ...
    async def _finalize_terms_enhanced(self, state: EnhancedSteelState) -> EnhancedSteelState:
